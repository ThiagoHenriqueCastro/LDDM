...
class _HomePageState extends State<HomePage> {
  ...
  void _calculate() {
    setState(() {
      ...
      if (imc > 40) {
        _descriptionText = "OBESIDADE GRAVE - GRAU II";
      } else if (imc > 30) {
        _descriptionText = "OBESIDADE - GRAU III";
      } else if (imc > 25) {
        _descriptionText = "SOBREPESO - GRAU I";
      } else if (imc > 18.5) {
        _descriptionText = "NORMAL";
      } else {
        _descriptionText = "MAGREZA";
      }
    });
  }
